...
import type { CreateResult, UpdateResult, RelationalDoc, DeleteCollectionResult, CascadeDeleteResult, BatchResult, RetryConfig } from "../../core/types";
export declare class RelationalCrudService implements IRelationalService {
    private readonly db;
...
//# sourceMappingURL=RelationalCrudService.d.ts.map